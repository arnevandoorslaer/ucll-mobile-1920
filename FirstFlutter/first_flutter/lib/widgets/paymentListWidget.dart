...
class PaymentList extends StatefulWidget {
  ...
  PaymentList({this.info, this.text});

  @override
  _PaymentListState createState() => _PaymentListState(info: info, text: text);
}

class _PaymentListState extends State<PaymentList> {
  List<Payment> info;
  String text;
  _PaymentListState({this.info, this.text});
                    ...
                    return new AlertDialog(
                      ...
                      actions: <Widget>[
                        new RaisedButton(onPressed: () {
                          HttpService.markAsPaid(payment.getPaymentId());
                          ...
                          child: new Text('Markeer als betaald', style: TextStyle(color: Color(0xff00285A))),
                          color: Colors.amber,
                        ),
                        new RaisedButton(onPressed: () {
                          Navigator.pop(context);
                          ...
                          child: new Text(
                            'Terug', style: TextStyle(color: Color(0xff00285A)),),
                          color: Colors.amber,
                        ),
                      ],
                    );
